...
class IndexEnumField(models.IntegerField):
    ...
    def get_prep_value(self, value):
        ...
        if value is None:
            ...
            raise TypeError(
                "Cannot convert value: %s (%s) to an int." % (value, type(value))
            )
    ...
    def to_python(self, value):
        ...
        if value is None:
            ...
            raise TypeError(
                "Cannot interpret %s (%s) as an OrderedRichEnumValue."
                % (value, type(value))
            )
...
class LaxIndexEnumField(IndexEnumField):
    ...
    def from_db_value(self, value, expression, connection, *args):
        ...
        return super(LaxIndexEnumField, self).from_db_value(
            value, expression, connection, *args
        )
...
class CanonicalNameEnumField(models.CharField):
    ...
    def get_prep_value(self, value):
        ...
        if value is None:
            ...
            raise TypeError(
                "Cannot convert value: %s (%s) to a string." % (value, type(value))
            )
    ...
    def to_python(self, value):
        ...
        if value is None:
            ...
            raise TypeError(
                "Cannot interpret %s (%s) as an RichEnumValue." % (value, type(value))
            )
    ...
    def formfield(self, **kwargs):
        # import here to avoid circular imports
        from django_richenum.forms.fields import (
            CanonicalEnumField as CanonicalEnumFormField,
        )

        defaults = {
            "enum": self.enum,
            "form_class": CanonicalEnumFormField,
        ...
        return super(models.CharField, self).formfield(
            **defaults
